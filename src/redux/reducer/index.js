...
import { GET_ALL_DEPORTES, GET_DEPORTE_DETAIL, CREATE_DEPORTE, DELETE_DEPORTE } from '../actions/index';
...
const rootReducer = (state = initialState, action) => {
   ...
   switch (action.type) {
      ...
      case DELETE_DEPORTE:
         return {
            ...state,
            deportes: state.deportes.filter(deport => {
               return deport.id !== action.payload;
            })
         };
